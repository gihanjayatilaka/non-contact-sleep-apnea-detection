...
def mainProg(videoFileName='3.mp4',jsonFileName='sendToServer.json',framesToProcess = 1000,x_1=275,y_1=246,x_2=326,y_2=317,smootheningParam=150,isPC=False):
    if videoFileName=='0':
...
if(len(sys.argv) == 1):
    ...
    mainProg(sys.argv[1],sys.argv[2],int(sys.argv[3]),int(sys.argv[4]),int(sys.argv[5]),int(sys.argv[6]),int(sys.argv[7]),bool(sys.argv[8]))
